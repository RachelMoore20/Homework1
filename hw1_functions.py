...
#*****************************************
#
# YOUR NAME: Rachel Moore
# NUMBER OF HOURS TO COMPLETE: 3.
# YOUR COLLABORATION STATEMENT(s) (refer to syllabus): I received assistance from Sami Rothstein on this assignment.
#
#*****************************************
...
# Please complete the four required functions below and create one new test case for each.
...
def areaofatriangle(m1, b1, m2, b2, m3, b3):
    ...
    px1 = (intersectionoftwolines_x(m1, b1, m2, b2))
    py1 = (intersectionoftwolines_y(m1, b1, m2, b2))
    px2 = (intersectionoftwolines_x(m1, b1, m3, b3))
    py2 = (intersectionoftwolines_y(m1, b1, m3, b3))
    px3 = (intersectionoftwolines_x(m2, b2, m3, b3))
    py3 = (intersectionoftwolines_y(m2, b2, m3, b3))

    a = (distancebetweenpoints(px1, py1, px2, py2))
    b = (distancebetweenpoints(px1, py1, px3, py3))
    c = (distancebetweenpoints(px2, py2, px3, py3))
...
print(distancebetweenpoints(0, 2, 2, 3) == math.sqrt(5)) #Here add at least one new test case here for distancebetweenpoints
print("*********")
...
print(round(intersectionoftwolines_y(3, 5, 4, 2),2) == 14) #Here add at least one new test case here for intersectionoftwolines_y
print("*********")

print("Heron's Formula:")
print(round(heronsformula(5, 5, 8), 2) == 12)
print(round(heronsformula(5, 5, 6), 2) == 12)
print(heronsformula(8, 7 ,3) == math.sqrt(108)) #Here add at least one new test case here for heronsformula
print("*********")
...
print(round(areaofatriangle(2, 0, 0, 0, -2, 20),2) == 50) #Here add at least one new test case here for areaofatriangle
print("*********")